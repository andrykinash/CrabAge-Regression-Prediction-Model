...
crab_data_no_sex = crab_data.drop(['Sex'], axis=1)

X = crab_data_no_sex.drop(['Age'], axis=1)
y = crab_data_no_sex['Age']

print("Data after label encoding:")
print(crab_data_no_sex.head())
...
# Compute MSE for SGD, BGD, and Normal Equation and print them
...
plt.figure()
plt.bar(labels, mse_values, color=['red', 'green', 'blue'])
plt.xlabel('Method')
plt.ylabel('MSE')
